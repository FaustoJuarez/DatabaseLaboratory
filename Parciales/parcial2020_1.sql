...
-- -----------------------------------------------------
-- Schema Parcial2020_1
-- -----------------------------------------------------
DROP SCHEMA IF EXISTS `Parcial2020_1` ;

-- -----------------------------------------------------
-- Schema Parcial2020_1
-- -----------------------------------------------------
CREATE SCHEMA IF NOT EXISTS `Parcial2020_1` DEFAULT CHARACTER SET utf8 ;
USE `Parcial2020_1` ;

-- -----------------------------------------------------
-- Table `Parcial2020_1`.`Escuelas`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `Parcial2020_1`.`Escuelas` ;

CREATE TABLE IF NOT EXISTS `Parcial2020_1`.`Escuelas` (
...
CREATE UNIQUE INDEX `codigo_UNIQUE` ON `Parcial2020_1`.`Escuelas` (`codigo` ASC) VISIBLE;


-- -----------------------------------------------------
-- Table `Parcial2020_1`.`Etapas`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `Parcial2020_1`.`Etapas` ;

CREATE TABLE IF NOT EXISTS `Parcial2020_1`.`Etapas` (
  `idEtapas` INT NOT NULL,
  `nombre` VARCHAR(15) NOT NULL,
  PRIMARY KEY (`idEtapas`))
ENGINE = InnoDB;

CREATE UNIQUE INDEX `nombre_UNIQUE` ON `Parcial2020_1`.`Etapas` (`nombre` ASC) VISIBLE;


-- -----------------------------------------------------
-- Table `Parcial2020_1`.`Curricula`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `Parcial2020_1`.`Curricula` ;

CREATE TABLE IF NOT EXISTS `Parcial2020_1`.`Curricula` (
...
CREATE UNIQUE INDEX `nombre_UNIQUE` ON `Parcial2020_1`.`Curricula` (`nombre` ASC) VISIBLE;


-- -----------------------------------------------------
-- Table `Parcial2020_1`.`Asignaturas`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `Parcial2020_1`.`Asignaturas` ;

CREATE TABLE IF NOT EXISTS `Parcial2020_1`.`Asignaturas` (
  `codigo` INT NOT NULL,
...
-- -----------------------------------------------------
-- Table `Parcial2020_1`.`Propuestas`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `Parcial2020_1`.`Propuestas` ;

CREATE TABLE IF NOT EXISTS `Parcial2020_1`.`Propuestas` (
  `idEscuela` INT NOT NULL,
  `idEtapas` INT NOT NULL,
  `idCurricula` INT NOT NULL,
  ...
  CONSTRAINT `fk_Escuelas_has_Etapas_Escuelas`
    ...
    REFERENCES `Parcial2020_1`.`Escuelas` (`idEscuela`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_Escuelas_has_Etapas_Etapas1`
    FOREIGN KEY (`idEtapas`)
    REFERENCES `Parcial2020_1`.`Etapas` (`idEtapas`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_Escuelas_has_Etapas_Curricula1`
    FOREIGN KEY (`idCurricula`)
    REFERENCES `Parcial2020_1`.`Curricula` (`idCurricula`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;

CREATE INDEX `fk_Escuelas_has_Etapas_Etapas1_idx` ON `Parcial2020_1`.`Propuestas` (`idEtapas` ASC) VISIBLE;

CREATE INDEX `fk_Escuelas_has_Etapas_Escuelas_idx` ON `Parcial2020_1`.`Propuestas` (`idEscuela` ASC) VISIBLE;

CREATE INDEX `fk_Escuelas_has_Etapas_Curricula1_idx` ON `Parcial2020_1`.`Propuestas` (`idCurricula` ASC) VISIBLE;


-- -----------------------------------------------------
-- Table `Parcial2020_1`.`Detalle`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `Parcial2020_1`.`Detalle` ;

CREATE TABLE IF NOT EXISTS `Parcial2020_1`.`Detalle` (
  `idCurricula` INT NOT NULL,
  `codigo` INT NOT NULL,
  `carga` INT NOT NULL,
  ...
  CONSTRAINT `fk_Curricula_has_Asignaturas_Asignaturas1`
    FOREIGN KEY (`codigo`)
    REFERENCES `Parcial2020_1`.`Asignaturas` (`codigo`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;

CREATE INDEX `fk_Curricula_has_Asignaturas_Asignaturas1_idx` ON `Parcial2020_1`.`Detalle` (`codigo` ASC) VISIBLE;

CREATE INDEX `fk_Curricula_has_Asignaturas_Curricula1_idx` ON `Parcial2020_1`.`Detalle` (`idCurricula` ASC) VISIBLE;
...
BEGIN
    ...
    BEGIN
        ...
        SET pMensaje = 'Error en la transacción. Contáctese con el administrador. SQLSTATE: ' OR @sqlstate;
        ROLLBACK;
    END;
